...
<form method="post" action="11multipart_upload.php" enctype="multipart/form-data" >

    <input type="hidden" name="MAX_FILESIZE" value="100 0000">
    选择文件1：<input type="file" name="myfileName[]"><br>
    选择文件2：<input type="file" name="myfileName[]"><br>
    选择文件3：<input type="file" name="myfileName[]"><br>

    <input type="submit" value="上传文件">
</form>
<?php
echo "<h2>4.2上传多个文件</h2>";
echo "<pre>";
print_r($_FILES);
echo "</pre>";
?>
  ...
  1.0 文件系统概述
   ...
   2.0 目录的基本操作
	...
	4.0 文件的上传与下载
        ...
        4.2 上传多个文件
                客户端name <input type='file' name='myfile[]'>
